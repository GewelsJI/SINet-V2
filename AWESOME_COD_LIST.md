...
|   2022   |  arXiv   | Generative Transformer for Accurate and Reliable Salient Object Detection <br> <sup><sub>*Yuxin Mao, Jing Zhang, Yuchao Dai, et al.*</sub></sup> | [Paper](https://arxiv.org/abs/2104.10127)/[Code](https://github.com/fupiao1998/TrasformerSOD)
...
|   2022   |   CVPR   | A Deeper Dive Into What Deep Spatiotemporal Networks Encode: Quantifying Static vs. Dynamic Information <br> <sup><sub>*Matthew Kowal, Mennatullah Siam, Md Amirul Islam, et al.*</sub></sup> | [Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Kowal_A_Deeper_Dive_Into_What_Deep_Spatiotemporal_Networks_Encode_Quantifying_CVPR_2022_paper.pdf)/[Code](https://github.com/YorkUCVIL/Static-Dynamic-Interpretability/)
| 2022 | ACCV | Betrayed by Motion: Camouflaged Object Discovery via Motion Segmentation <br> <sup><sub>*Hala Lamdouar, Charig Yang, Weidi Xie, et al.*</sub></sup> | [Paper](https://openaccess.thecvf.com/content/ACCV2020/html/Lamdouar_Betrayed_by_Motion_Camouflaged_Object_Discovery_via_Motion_Segmentation_ACCV_2020_paper.html)/[Code](https://github.com/hlamdouar/MoCA/)
| 2022 | arXiv | EM-driven unsupervised learning for efficient motion segmentation <br> <sup><sub>*Etienne Meunier, Ana¨ıs Badoual, and Patrick Bouthemy.*</sub></sup> | [Paper](https://arxiv.org/pdf/2201.02074.pdf)/[Code](https://github.com/Etienne-Meunier-Inria/EM-Flow-Segmentation)
| 2022 | arXiv | Quantifying and Learning Static vs. Dynamic Information in Deep Spatiotemporal Networks <br> <sup><sub>*Matthew Kowal, Mennatullah Siam, Md Amirul Islam, et al.*</sub></sup> | [Paper](https://arxiv.org/pdf/2211.01783.pdf)/[Code](https://yorkucvil.github.io/Static-Dynamic-Interpretability/)
